...
export function QuickAddInput({ onAdd, placeholder = "Add a priority...", className, formId, hideButton }: QuickAddInputProps) {
  ...
  return (
    <form id={formId} onSubmit={handleSubmit} className={`flex items-center gap-2 ${className}`}>
      <Input
        value={text}

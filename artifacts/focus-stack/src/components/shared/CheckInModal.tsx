...
import { CheckCircle2, ArrowRight, X, Moon, Flame, ChevronRight } from 'lucide-react';
...
interface CheckInModalProps {
  ...
  dayPlans: DayPlan[];
  onSave: (updates: { id: string; action: Action }[], reflection?: Reflection) => void;
}
...
function getMicroInsight(doneCount: number, total: number, deferredHighImpact: number): string {
  if (deferredHighImpact >= 2) {
    return `You deferred ${deferredHighImpact} high-impact tasks. Try tackling your hardest item first tomorrow.`;
  }
  if (deferredHighImpact === 1) {
    return 'You deferred 1 high-impact task. Starting your day with it tomorrow builds momentum.';
  }
  if (total > 0 && doneCount === total) {
    return "Perfect execution today. You're building real momentum — keep it going.";
  }
  if (total > 0 && doneCount / total >= 0.75) {
    return 'Strong day. Small planning refinements will get you to 100%.';
  }
  if (doneCount === 0 && total > 0) {
    return 'Rough day? That happens. Reflection like this is what separates consistent performers.';
  }
          ...
          <>
            ...
            <div className="overflow-y-auto flex-1 px-6 pb-2 space-y-2.5">
              ...
              {priorities.map(p => {
                ...
                return (
                  <div key={p.id} className="rounded-2xl p-4" style={GLASS_ITEM}>
                    <p className={cn(
            ...
            <div className="px-6 pt-3 pb-6 shrink-0 flex flex-col gap-2">
              <button
                ...
                style={{ background: allDecided || total === 0 ? '#222527' : 'rgba(34,37,39,0.35)' }}
              >
                Continue
          ...
          <div className="overflow-y-auto flex-1 flex flex-col">
            <div className="flex-1 px-6 pb-2 space-y-3">
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  <div
                    ...
                    style={{ background: doneCount > 0 ? 'rgba(107,143,110,0.18)' : 'rgba(34,37,39,0.06)' }}
                  >
                ...
                {deferredCount > 0 && (
                  <div className="flex items-center gap-2">
                    <div
                      className="h-7 w-7 rounded-full flex items-center justify-center shrink-0"
                      style={{ background: deferredHighImpact > 0 ? 'rgba(245,158,11,0.12)' : 'rgba(34,37,39,0.06)' }}
                    >
                    ...
                    <p className="text-sm text-[#222527]/80">
                      ...
                      {deferredHighImpact > 0 && (
                        <span className="text-amber-700/70">
                          ({deferredHighImpact} high-impact)
                        </span>
                      )}
              ...
              <div
                ...
                style={{ background: 'rgba(255,240,200,0.55)', border: '1px solid rgba(245,200,80,0.30)' }}
              >
                <div
                ...
                <div>
                  <p className="text-sm font-semibold text-[#222527]">
                    {todayStreak === 1
                      ? 'Check-in streak started!'
                      : `${todayStreak} days of consistent check-ins`}
                  </p>
              ...
              <div
                ...
                style={{ background: 'rgba(255,255,255,0.55)', border: '1px solid rgba(255,255,255,0.70)' }}
              >
                <p className="text-xs font-semibold uppercase tracking-widest text-[#222527]/40 mb-3">
              ...
              <div
                ...
                style={{ background: 'rgba(220,230,215,0.45)', border: '1px solid rgba(107,143,110,0.22)' }}
              >
                <div
                ...
                <div>
                  ...
                  <p className="text-xs leading-relaxed text-[#222527]/65">
